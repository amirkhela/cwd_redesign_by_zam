...
export const metadata: Metadata = {
  title: "Web Design North York | GTA's Best-Value Agency | From $1,499 | Free Quote | CWD",
  description:
    "Top-rated web design & SEO in North York — custom sites from $1,499 that rank faster than downtown Toronto. Lower GTA competition, same buyer intent. 180+ reviews. Free quote — (647) 689-6069.",
