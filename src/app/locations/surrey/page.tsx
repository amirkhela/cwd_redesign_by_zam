...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      `Top-rated web design & SEO in Surrey BC. ${reviewCountPlus(config.reviewCount)} Google reviews. Custom websites built to rank on Google and win local customers across Metro Vancouver.`,
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8 w-full">
          ...
          <div className="max-w-2xl">
            <div className="hero-fade-up inline-flex items-center gap-2.5 px-4 py-2 rounded-full glass mb-6">
              ...
              <span className="text-white/80 text-sm font-medium tracking-wide">Surrey, BC — {reviewCountPlus(config.reviewCount)} Google Reviews</span>
            </div>
            ...
            <div className="hero-fade-up-3 flex flex-wrap gap-5 mt-8">
              {[`${reviewCountPlus(config.reviewCount)} Google Reviews`, "Surrey SEO Difficulty: 21 — Highly Achievable", "Results or We Keep Working"].map((t) => (
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl p-8 reveal border border-gray-100" style={{ boxShadow: "0 2px 24px rgba(0,0,0,0.07)" }}>
            <div className="grid sm:grid-cols-4 gap-6 text-center">
              {[{ value: reviewCountPlus(config.reviewCount), label: "Google Reviews" }, { value: "590/mo", label: "Surrey Web Design Searches" }, { value: "30–90", label: "Days to First Rankings" }, { value: "100%", label: "Results Guaranteed" }].map((s) => (
