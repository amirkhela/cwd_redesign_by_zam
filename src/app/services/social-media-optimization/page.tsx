...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Plans depend on how many platforms you need and how much content we create each month. Pricing scales with your scope — request a free quote and we'll scope the right plan for your goals and budget." },
    },
    {
      "@type": "Question",
