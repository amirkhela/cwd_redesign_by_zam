...
export const metadata: Metadata = {
  title: "Google Ads Management Toronto & Canada | Canadian Web Designs",
  description:
    "Professional Google Ads management for Toronto businesses. Stop wasting budget — we build campaigns that generate qualified leads at the lowest possible cost. Free audit — (647) 689-6069.",
