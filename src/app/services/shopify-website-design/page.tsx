        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <div className="hero-fade-up inline-flex items-center gap-2.5 px-4 py-2 rounded-full glass mb-6">
              ...
              <span className="text-white/80 text-sm font-medium tracking-wide">Shopify Experts — {reviewCountPlus(config.reviewCount)} Google Reviews</span>
            </div>
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl p-8 reveal border border-gray-100" style={{ boxShadow: "0 2px 24px rgba(0,0,0,0.07)" }}>
            <div className="grid sm:grid-cols-4 gap-6 text-center">
              {[{ value: "#2", label: "Most-Used Platform on the Web" }, { value: "Ottawa", label: "Where Shopify Was Born" }, { value: reviewCountPlus(config.reviewCount), label: "Google Reviews" }, { value: "100%", label: "Store Ownership — Your Account" }].map((s) => (
