...
export const metadata: Metadata = {
  title: "Website Maintenance Canada | From $99/mo | Hack Protection | Daily Backups | Free Audit | CWD",
  description: "Is your website one update away from breaking? Expert maintenance from $99/mo — daily backups, 24/7 monitoring, malware removal & speed tuning. No lock-in. Free audit: (647) 689-6069.",
  alternates: { canonical: "/services/website-maintenance" },
  openGraph: {
    title: "Website Maintenance Canada | From $99/mo | Hack Protection | Daily Backups | Free Audit | CWD",
    description: "Expert website maintenance from $99/mo — daily backups, 24/7 uptime monitoring, malware removal & Core Web Vitals tuning. No lock-in contracts. Free audit: (647) 689-6069.",
