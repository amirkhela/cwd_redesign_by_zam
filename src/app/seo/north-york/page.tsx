...
export const metadata: Metadata = {
  ...
  description:
    `North York SEO that beats downtown Toronto agencies — lower difficulty, same buyer intent. ${reviewCountPlus(config.reviewCount)} reviews. Free audit — (647) 689-6069.`,
  alternates: { canonical: "/seo/north-york" },
  openGraph: {
    title: "SEO North York | SEO Services | Canadian Web Designs",
    description:
      `Expert SEO services in North York, ON. Rank on Google page 1 for North York searches. ${reviewCountPlus(config.reviewCount)} Google reviews. Free audit — (647) 689-6069.`,
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8 w-full">
          ...
          <div className="max-w-2xl">
            <div className="hero-fade-up inline-flex items-center gap-2.5 px-4 py-2 rounded-full glass mb-6">
              ...
              <span className="text-white/80 text-sm font-medium tracking-wide">North York, ON — {reviewCountPlus(config.reviewCount)} Google Reviews</span>
            </div>
