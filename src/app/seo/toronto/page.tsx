...
export const metadata: Metadata = {
  ...
  description:
    `Toronto SEO with proven results — neighbourhood strategy for Etobicoke, Scarborough & North York. ${reviewCountPlus(config.reviewCount)} reviews. Free audit → (647) 689-6069.`,
  alternates: { canonical: "/seo/toronto" },
  openGraph: {
    title: "SEO Toronto | SEO Company & Services | Canadian Web Designs",
    description:
      `Toronto's trusted SEO agency — ${reviewCountPlus(config.reviewCount)} Google reviews, proven rankings across every GTA neighbourhood. Free audit — (647) 689-6069.`,
...
const faq = [
  ...
  },
  {
    ...
    a: `Three differences: we focus on rankings that drive revenue (not just impressions), we're transparent about what we're doing and why, and we back our work with a results guarantee. With ${reviewCountPlus(config.reviewCount)} Google reviews and clients across every major Toronto neighbourhood and industry, our track record is publicly verifiable. We don't lock you into long contracts — we earn your business month after month.`,
  },
  {
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8 w-full">
          ...
          <div className="max-w-2xl">
            ...
            <div className="hero-fade-up-3 flex flex-wrap gap-5 mt-8">
              {[`${reviewCountPlus(config.reviewCount)} Google Reviews`, "Custom-Quoted Packages", "No Long-Term Contracts"].map((t) => (
            ...
            <div className="relative hidden lg:block">
              <HeroQuoteForm source="seo-toronto" />
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="bg-white rounded-2xl p-7 border border-gray-100 mb-5" style={{ boxShadow: "0 2px 24px rgba(0,0,0,0.07)" }}>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    `${reviewCountPlus(config.reviewCount)} Google reviews — the most publicly verifiable track record in Toronto`,
