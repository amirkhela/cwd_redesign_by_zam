...
export const metadata: Metadata = {
  title: "Web Design Canada | #1 Rated Agency | From $1,499 | Free Quote | CWD",
  description:
    `Canada's #1 rated web design agency — ${config.reviewCount}+ five-star reviews. Custom sites from $1,499, engineered to rank on Google & convert visitors into paying customers. Toronto, Vancouver, Calgary & coast to coast. Free quote — (647) 689-6069.`,
  alternates: { canonical: "/" },
  openGraph: {
    title: "Web Design Canada | #1 Rated Agency | From $1,499 | Free Quote | CWD",
    description: `${config.reviewCount}+ five-star reviews. Custom sites from $1,499 — engineered to rank on Google & convert visitors into paying customers. Serving all of Canada. Free quote — (647) 689-6069.`,
