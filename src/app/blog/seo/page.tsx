...
export const metadata: Metadata = {
  title: { absolute: "SEO Tips & Strategies for Canadian Businesses | Canadian Website Design" },
  ...
  openGraph: {
    ...
    description: "Expert SEO tips, guides, and strategies for Canadian businesses.",
    ...
    <>
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <div className="hero-fade-up inline-flex items-center gap-2.5 px-4 py-2 rounded-full glass mb-6">
              ...
              <span className="text-white/80 text-sm font-medium tracking-wide">SEO Tips & Guides</span>
            </div>
            <h1 className="hero-fade-up-1 font-black text-white mb-5" style={{ fontSize: "clamp(1.8rem, 4vw, 2.6rem)", lineHeight: 1.05 }}>
              SEO Tips &amp; Guides for{" "}<span className="gradient-text-animated">Canadian Businesses</span>
            </h1>
            <p className="hero-fade-up-2 text-xl text-white/60 leading-relaxed">
              Expert search engine optimization strategies to help your Canadian business rank higher on Google, drive organic traffic, and grow sustainably. From local SEO and keyword research to technical audits and link building — everything you need to dominate search results.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-section-y bg-white">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          {posts.length === 0 ? (
            <p className="text-center text-gray-500 py-20">No SEO articles found.</p>
          ) : (
